...
wLayout="${confDir}/wlogout/layout_2"
wlTmplt="${confDir}/wlogout/style_2.css"
...
wlogout -b "${wlogoutStyle}" -c 0 -r 0 -m 0 --layout "${wLayout}" --css <(echo "${wlStyle}") --protocol layer-shell
